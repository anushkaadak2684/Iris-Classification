...
A simple Machine Learning classification project using the classic Iris Dataset.
This project demonstrates how to train and evaluate ML models to classify Iris flower species based on their physical measurements.
...
Dataset file present in the repository:
Iris.csv
...
git clone https://github.com/anushkaadak2684/Iris-Classification.git
